...
1. ...luego hay que ir al interior de ese subdirectorio (con cd subdirectorio)...
1. ...luego hacer un "git add (nombre archivo con su extension) desde el subdirectorio...(repetir para cada archivo)
1. ...luego haces un "commit -a" (añadir algo de descripción y cerrar grabando)... 
