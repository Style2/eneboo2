...
Tema 3. Sistemas ERP (Enterprise Resource Planning). Práctica AbanQ-FACTURACIÓN
Parte I. El Sistema de Información empresarial y los Sistemas de Planificación de Recursos Empresariales (ERP). 
Introducción.



En este apartado se analizarán los siguientes aspectos en relación con la aplicación AbanQ:
1. Arquitectura de Abanq.
2. Explicación breve de los principales botones de la aplicación.
...
Explicación breve de los botones utilizados en el programa.
 ...
 o  Aceptar los cambios e ir al primer registro (F5).
 o  Aceptar los cambios e ir al registro anterior (F6).
 o  Aceptar los cambios e ir al registro siguiente (F7).
 o  Aceptar los cambios e ir al último registro (F8).
 o  Aceptar los cambios y continuar con la edición de un nuevo registro (F9).
 o  Aceptar los cambios y cerrar formulario (F10).
 o  Cancelar los cambios y cerrar formulario (Esc).
 o  Insertar registro (A).
 o  Modificar registro (M).
 o  Eliminar registro (E).
 o  Ver registro (V).
 o  Copiar registro (C)
 o  Imprimir tabla (I)
o  Seleccionar fecha (F2)
...
Oficina nº: 0182 (ó 0183 si ya existiera) (Nombre: Nervión. Dirección: Avda. Buhaira, 2, 41018 – Sevilla – País: ES . Contacto: Contacto: Julián Amores Soto, teléfono 954 214 541, fax: 954 214 542)
...
La tercera opción de Fiscalidad es Impuestos. Por defecto, el programa ya tiene configurado tres códigos de IVA, uno para el IVA general del 18%, otro para el reducido del 8% y un tercero para el superreducido del 4%. (Se debe a que estamos trabajando con una versión del año 2012, pues la del 2013 dio problemas al instalarla).
...
3. Facturas rectificativas de proveedores.
4. Tesorería/Recibos de proveedores.
...
2. Botón generar albarán. Crear un albarán desde un pedido.
3. Botón generar factura. Crear una factura desde un pedido.
...
2. Desde la ventana de Albaranes de Proveedores, a través del botón Asociar. Esta segunda opción se explicará más adelante, en la sección dedicada a los albaranes.
...
Los alabaranes incluidos quedarán marcados como no pendientes de facturas, y no se podrán modificar. La nueva factura, al ser la forma de pago al contado, 
...
En esta ventana realizaremos la siguiente práctica:
1. Pago de un recibo.
2. Devolución de un recibo.
3. Posponer parte del pago de un recibo.
...
4. Facturas rectificativas a clientes
5. Tesorería/Recibos de clientes
6. Tesorería/Remesas de clientes
...
2. Insertar registro con anticipo. Creación de un pedido pidiendo parte del importe total.
3. Generar albarán a partir de un pedido.
...
2. Botón Asociar.
3. Generar factura desde un albarán A1 (F1)
...
2. Devoluciones de mercancía o anulación de operaciones. 
3. Descuentos por alcanzar un volumen de compra (rappels). 
