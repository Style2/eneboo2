...
Como veremos más adelante, es muy común en la arquitectura de Abanq establecer conexiones entre objetos.
...
programador de scripts, el motor de Abanq también publica una serie de clases que nos permiten acceder a
...
automáticamente por el motor de Abanq en ciertos momentos de la ejecución del formulario.
...
Crearemos el informe empleados.kut. El editor que Abanq nos propone para este tipo de archivos es
...
Éste es en esencia el objetivo de Abanq: proporcionar un solución informática que se adapte a la forma de
